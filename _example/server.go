...
const ConnectionStringEnv = "DB_CONNSTR"

// Server provides the API.
type Server struct {
	Connection         *connection.Connection
	AccountRepo        *repo.AccountRepo        // Account repository
	AccountSettingRepo *repo.AccountSettingRepo // Account Setting repository
	SettingRepo        *repo.SettingRepo        // Setting repository
...
func NewServer(
	...
	s.AccountRepo = repo.NewAccountRepo(s.Connection)
	s.AccountSettingRepo = repo.NewAccountSettingRepo(s.Connection)
	s.SettingRepo = repo.NewSettingRepo(s.Connection)
	return s
}
